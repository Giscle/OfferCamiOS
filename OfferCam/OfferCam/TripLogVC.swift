...
class TripLogVC: UIViewController {
    ...
    deinit {
        print("TripViewController deinit")
    }
}
extension TripLogVC : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
